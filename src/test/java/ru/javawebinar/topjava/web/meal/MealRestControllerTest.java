...
public class MealRestControllerTest extends AbstractControllerTest {
    ...
    public void testGetAll() throws Exception {
        mockMvc.perform(get(REST_URL).with(userAuth(USER)).contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andDo(print())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
    ...
    public void testGetBetween() throws Exception {
        mockMvc.perform(get(REST_URL + "between?startDateTime=2015-05-30T07:00&endDateTime=2015-05-31T11:00:00").with(userAuth(USER)))
                .andExpect(status().isOk())
                .andDo(print())
