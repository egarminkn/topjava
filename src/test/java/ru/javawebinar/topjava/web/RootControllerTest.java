        ...
        mockMvc.perform(get("/meals"))
                ...
                .andExpect(model().attribute("meals", hasItems(
                        allOf(
                                ...
                                hasProperty("exceed", is(MEAL1.getCalories() + MEAL2.getCalories() + MEAL3.getCalories() > USER.getCaloriesPerDay()))
                        ),
                        allOf(
                        ...
                        allOf(
                                ...
                                hasProperty("exceed", is(MEAL4.getCalories() + MEAL5.getCalories() + MEAL6.getCalories() > USER.getCaloriesPerDay()))
                        ),
                        allOf(
