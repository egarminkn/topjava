...
public class JdbcMealRepositoryImpl implements MealRepository {
    ...
    public Meal save(Meal meal, int userId) {
        ...
        if (meal.isNew()) {
            Number id = jdbcInsert.executeAndReturnKey(mapMeal);
            meal.setId(id.intValue());
        } else {
            if (namedJdbcTemplate.update("UPDATE meals SET date_time=:date_time, calories=:calories, description=:description " +
