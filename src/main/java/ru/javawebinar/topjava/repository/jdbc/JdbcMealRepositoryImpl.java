 ...
 * Date: 26.08.2014
 */
public abstract class JdbcMealRepositoryImpl<DateTimeClass> implements MealRepository {
    ...
    protected abstract DateTimeClass convertLocalDateTime(LocalDateTime localDateTime);
